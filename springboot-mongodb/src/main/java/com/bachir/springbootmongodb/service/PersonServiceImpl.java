...
import com.bachir.springbootmongodb.repository.PersonRepository;
...
public class PersonServiceImpl implements PersonService{
    ...
    public Page<Person> search(String name, Integer minAge, Integer maxAge, String city, Pageable pageable) {
        ...
        Page<Person> people= PageableExecutionUtils
                .getPage(mongoTemplate.find(query,Person.class),pageable,()->mongoTemplate.count(query.skip(0).limit(0),Person.class));
        return people;
    }
